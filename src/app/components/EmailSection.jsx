        ...
        <div className="z-10">
          ...
          <div className="socials flex flex-row gap-2">
            <Link href="https://github.com/martincout" target="_blank">
              <Image src="/github-icon.png" width={30} height={30}
                alt="Github Icon" />
            </Link>
        ...
        {/* <div>
          {emailSubmitted ? (
            ...
            <form className="flex flex-col" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="bg-primary hover:bg-indigo-500 transition-colors delay-10 text-white font-medium py-2.5 px-5 rounded-lg w-full"
              >
                Send Message
              </button>
            </form>
