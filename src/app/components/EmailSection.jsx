  ...
  return (
    <div className="flex flex-col">
      ...
      >
        ...
        <div className="z-10">
          <h5 className="text-4x1 font-bold text-white my-2">
            Let&apos;s Connect
          </h5>
            ...
            <form className="flex flex-col" onSubmit={handleSubmit}>
              <div className="mb-6">
                ...
                <input
                  ...
                  placeholder="contact@martincoutinho.com"
                />
              </div>
              <div className="mb-6">
                <label
              ...
              <button
                type="submit"
                className="bg-secondary hover:bg-indigo-500 transition-colors delay-10 text-white font-medium py-2.5 px-5 rounded-lg w-full"
              >
                Send Message
              </button>
            </form>
