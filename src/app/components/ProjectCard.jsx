...
const ProjectCard = ({ imgUrl, title, description, gitUrl, previewUrl }) => {
  return (
    <div>
      <div
        className="h-52 md:h-72 rounded-t-xl relative group bg-center bg-cover bg-no-repeat border-orange-300 border-3"
      ...
      <div className=" rounded-b-xl mt-3 bg-[#181818]py-6 px-4">
        <h5 className="dark:text-white text-xl font-semibold mb-2">{title}</h5>
